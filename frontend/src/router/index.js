...
const routes = [
  ...
  { path: '/oauth/:provider', name: 'oauth-callback', component: () => import('../views/OAuthCallbackView.vue'), meta: { id: 'SCR-AUTH-004', public: true } },
  ...
  { path: '/companions/:id/chat', name: 'companion-chat', component: () => import('../views/CompanionChatView.vue'), meta: { id: 'SCR-MATE-003' } },
  { path: '/logs/:id', name: 'log-detail', component: () => import('../views/LogDetailView.vue'), meta: { id: 'SCR-LOG-003' } },
  { path: '/notifications', name: 'notifications', component: () => import('../views/NotificationView.vue'), meta: { id: 'SCR-NOTI-001' } },
  { path: '/standings', name: 'standings', component: () => import('../views/StandingsView.vue'), meta: { id: 'SCR-GAME-003', public: true } },
